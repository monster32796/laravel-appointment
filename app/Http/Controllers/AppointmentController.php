...
class AppointmentController extends Controller
{
    ...
    public function check(Request $request)
    {
        ...
        if (!$appointment) {
            return redirect()->to('/appointment')->with('errMessage', 'The appointment time is not available for this date');
        };
    ...
    public function updateTime(Request $request)
    {
        ...
        return redirect()->route('appointment.index')->with('message', 'The appointment time for ' . $date . ' is updated successfully!');
    }
}
