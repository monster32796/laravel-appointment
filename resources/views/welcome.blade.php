				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-6 col-sm-8">
							<a class="nav-link" href="{{ route('health-materials') }}"><i class="bi bi-megaphone-fill"></i>  {{ __('Health Promotion Messages') }}</a>
						</div><div class="col-md-6 col-sm-8">
							<a class="nav-link" href="{{ route('login') }}"><i class="bi bi-calendar-week"></i>  {{ __('Manage Appointment') }}</a>
						</div><div class="col-md-6 col-sm-8">
							<a class="nav-link" href="{{ route('about-us') }}"><i class="bi bi-info-square-fill"></i>  {{ __('About Us') }}</a>
						</div><div class="col-md-6 col-sm-8">						
						<a class="nav-link" href="{{ route('services') }}"><i class="bi bi-patch-exclamation-fill"></i>  {{ __('Services') }}</a>
						</div>						
					</div>
				</div>
			</div>
