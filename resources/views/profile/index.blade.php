...
@section('content')
    <div class="container">
        ...
        <div class="row ">
                        ...
                        <form action="{{ route('profile.store') }}" method="post">@csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-primary" type="submit">Update Profile <i class="bi bi-arrow-repeat"></i></button>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header">Upload My Profile Photo</div>
                    <form action="{{ route('profile.pic') }}" method="post" enctype="multipart/form-data">@csrf
                        <div class="card-body">
                            ...
                            @enderror
                            <button type="submit" class="btn btn-primary">Update Image <i class="bi bi-arrow-repeat"></i></button>
