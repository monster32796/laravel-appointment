...
class FrontEndController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($check) {
            return redirect()->back()->with('errMessage', 'You already made an appointment for selected date. Please check your email for the appointment details!');
        }
        ...
        return redirect()->back()->with('message', 'Your appointment was booked at ' . $date . ' at ' . $time . ' with Dr' . $doctor->name . '.');
    }
